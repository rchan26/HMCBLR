...
#include "stanExports_bayes_logistic.h"

RCPP_MODULE(stan_fit4bayes_logistic_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bayes_logistic")
