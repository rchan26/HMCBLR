...
namespace model_bayes_logistic_namespace {
using std::istream;
using std::string;
...
class model_bayes_logistic
  : public stan::model::model_base_crtp<model_bayes_logistic> {
private:
        int nsamples;
        int p;
        vector_d y;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bayes_logistic_namespace::model_bayes_logistic";
        ...
        try {
            ...
            X = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(nsamples, (p + 1));
            vals_r__ = context__.vals_r("X");
            pos__ = 0;
            size_t X_j_2_max__ = (p + 1);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bayes_logistic_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bayes_logistic_namespace::model_bayes_logistic stan_model;
#ifndef USING_R
